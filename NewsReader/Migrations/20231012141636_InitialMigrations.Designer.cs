...
namespace NewsReader.Migrations
{
    ...
    [Migration("20231012141636_InitialMigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsReader.Domain.Models.NewsKeyword", b =>
                {
                    ...
                    b.Property<int>("FKKeywordId")
                        .HasColumnType("int");

                    b.Property<Guid>("FKNewsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("FKKeywordId");
            ...
            modelBuilder.Entity("NewsReader.Domain.Models.NewsKeyword", b =>
                {
                    b.HasOne("NewsReader.Domain.Models.Keyword", "FKKeyword")
                        .WithMany("NewsKeywords")
                        .HasForeignKey("FKKeywordId")
                        .IsRequired();

                    b.HasOne("NewsReader.Domain.Models.News", "FKNews")
                        .WithMany("NewsKeywords")
                        .HasForeignKey("FKNewsId")
                        .IsRequired();

                    b.Navigation("FKKeyword");
